    ...
    return (
        <div className='container'>
            ...
            <div className="row text-center justify-content-center" style={{marginTop: '25px', marginBottom: '25px'}}>
                <h2>
                    Щось пішло не так. Перевірте чи всі дані були правильно введені. У випадку якщо все всерівно не працює, дати Святику підсрачника за те що не працює База Даних
                </h2>
            </div>
